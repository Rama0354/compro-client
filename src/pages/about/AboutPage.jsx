    ...
    return (
        <div className="w-full min-h-[608px] bg-white p-6 my-6">
            ...
            <div className='w-full my-3 flex flex-col gap-6'>
                <div className='h-38 sm:h-96 overflow-hidden flex items-center'>
                    <LazyLoadImage placeholderSrc={baseURL+setting.thumbnail_image} src={baseURL + setting.image} alt="ptbimage" />
                </div>
