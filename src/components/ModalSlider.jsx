...
const ModalSlider = ({st,setSt,refreshSlider,successNotif,failNotif}) => {
    ...
    return (
        <>
        <div className="fixed top-0 z-30 left-0 right-0 bg-slate-600/25 w-full h-full flex justify-center items-center backdrop-blur-sm dismiss" onClick={handleClick}>
            <div className="relative max-w-xs xs:max-w-sm sm:max-w-lg bg-white rounded-md animate-fadeIn">
                ...
                <div className="w-full relative p-3 overflow-hidden">
                    ...
                    <p ref={errRef} className={errMsg ? "font-poppins text-rose-600 text-sm" : "hidden"} aria-live='assertive'>{errMsg}</p>
                        ...
                        <div className='flex gap-6 justify-center border-t border-slate-300 p-3'>
